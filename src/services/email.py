...
async def send_email(email: EmailStr, username: str, host: url):
    ...
    The send_email function sends an email to the user with a link to confirm their email address.
        The function takes in three parameters:
            ...
            -host: url, this is where we are hosting our application (e.g., http://localhost).  We need this so that we can create a link for them to click on.

    :param email: EmailStr: Specify the email address of the recipient
    :param username: str: Pass the username of the user to be sent an email
    :param host: url: Pass the host url to the template
